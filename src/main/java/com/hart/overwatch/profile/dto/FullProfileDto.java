...
public class FullProfileDto {
    ...
    public FullProfileDto(UserProfileDto userProfile, BasicInfoDto basicInfo,
            ProfileSetupDto profileSetup, SkillsDto skills, WorkExpsDto workExp, PackagesDto pckg,
