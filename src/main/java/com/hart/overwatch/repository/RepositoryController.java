...
public class RepositoryController {
    ...
    public ResponseEntity<GetRepositoryReviewResponse> searchRepository(
            ...
            @RequestParam("githubId") Long githubId) throws IOException {
        return ResponseEntity.status(HttpStatus.OK).body(new GetRepositoryReviewResponse("success",
                this.repositoryService.searchRepository(githubId, page, size, repoName, query)));
    }
    ...
    ResponseEntity<GetRepositoryReviewResponse> getRepositoryReview(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new GetRepositoryReviewResponse("success",
                this.repositoryService.getRepositoryReview(repositoryId, githubId, page, size)));
    }
