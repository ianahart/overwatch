...
export interface ITopicDetailsCommentModalProps {
  topicId: number;
}

const TopicDetailsCommentModal = ({ topicId }: ITopicDetailsCommentModalProps) => {
  const MAX_CHARS = 400;
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-90">
          <div className="m-2 flex justify-end">
            <div onClick={handleOnCloseModal} className="bg-black p-2 rounded-3xl cursor-pointer">
...
export default TopicDetailsCommentModal;
