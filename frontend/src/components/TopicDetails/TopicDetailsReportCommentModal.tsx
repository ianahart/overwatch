...
export interface ITopicDetailsReportCommentModalProps {
...
const TopicDetailsReportCommentModal = ({
  currentUserId,
  commentId,
  content,
  closeReportCommentModal,
}: ITopicDetailsReportCommentModalProps) => {
...
export default TopicDetailsReportCommentModal;
