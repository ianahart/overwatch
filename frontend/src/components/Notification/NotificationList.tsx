...
const NotificationList = ({ notifications, deleteNotification }: INotificationListProps) => {
  return (
    <div className="p-2">
        ...
        return (
          <div key={notification.id} className="my-2">
            <div className="flex justify-end">
              <AiOutlineClose onClick={() => deleteNotification(notification)} className="text-gray-400" />
            </div>
            ...
            {notification.notificationRole === NotificationRole.RECEIVER &&
              notification.notificationType === NotificationType.CONNECTION_REQUEST_PENDING && (
                <div className="flex justify-center">
                  ...
                  <button className="bg-gray-400 text-xs rounded-lg p-2 text-black mx-1">Deny</button>
                </div>
              )}
            <div className="flex justify-end">
